package com.xue.base_common_library.state

import androidx.lifecycle.MutableLiveData
import com.xue.base_common_library.network.AppException
import com.xue.base_common_library.network.BaseNetworkResponse
import com.xue.base_common_library.network.NetworkExceptionHandle
...
fun <T> MutableLiveData<ResultState<T>>.paresException(e: Throwable) {
    this.value = ResultState.onAppError(NetworkExceptionHandle.handleException(e))
}
