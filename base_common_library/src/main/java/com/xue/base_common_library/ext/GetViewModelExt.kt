package com.xue.base_common_library.ext
 ...
 */
@Suppress("UNCHECKED_CAST")
fun <VM> getVmClazz(obj: Any, num: Int): VM {
    return (obj.javaClass.genericSuperclass as ParameterizedType).actualTypeArguments[num] as VM
}
